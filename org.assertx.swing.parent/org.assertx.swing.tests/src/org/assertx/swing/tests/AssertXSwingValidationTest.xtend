...
class AssertXSwingValidationTest {
	...
	def void testEmptySettingsSection(){
		...
		}'''.parse.assertWarning(AssertXSwingPackage.eINSTANCE.AXSSettings,
	...
	@Test
	def void testNonEmptySettingsAreOk(){
		'''
		testing javax.swing.JFrame
	...
	def void testEmptyStringAsMethodNameIssueWarning(){
		...
		input.parse.assertWarning(AssertXSwingPackage.eINSTANCE.AXSTestMethod,
	...
	def private void assertAutogeneratedMethod(AXSTestCase model, String methodName, EClass type){
		model.assertError(type,
			AssertXSwingValidator.AUTOGENERATED_METHOD_ACCESSED,
			'The method "' + methodName + '" is autogenerated from other parts of the test case definition and it is part of a fixed workflow. You cannot call it'
		)
	}
